...
const Travelers = () => {
    return (
        <div className="flex items-center justify-between p-8 bg-yellow-50 rounded-lg font-serif">
            ...
            <div className="flex flex-col gap-4 max-w-md">
                <img
                    ...
                    className="w-12 h-12"
                />
                <h2 className="text-3xl font-serif">Travelers&lsquo; Choice Awards Best of the Best</h2>
